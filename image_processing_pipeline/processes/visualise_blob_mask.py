...
class VisuliseBlobMask(AbstractProcessStep):
    ...
    def _execute(self):
        blob_color=(1.0, 0.0, 0.0)  # dark blue
        bg_color=(0.0, 1.0, 0.0)    # light blue
        alpha_blob=0.125
        alpha_bg=0.1
...
process_steps["VisualiseBlobMask"] = VisuliseBlobMask
